...
<html>
        ...
        <link rel="stylesheet" href="https://akhir.s3.amazonaws.com/modall.css" type="text/css">
<head>
...
<br>
        ...
        <div class="area"></div><nav class="main-menu">
          ...
          <a href="login.php">
                ...
                <h1><center><span class="purple">WISATA</span> <span class="yellow">ALAM</span></h1>
        <br>
<table class="container hover" id="table_id">
  ...
  while($data = mysqli_fetch_array($sql)){ // Ambil semua data dari hasil eksekusi $sql
    ...
    echo "<td>"."<center>".$data['Lokasi']."</td>";
    echo "<td>"."<center>".$data['Ringkasan']."</td>";
    echo "<td><center><a href='formgunung.php?Id=".$data['Id']."'>Ubah</a></td>";
    echo "<td><center><a href='hapusgunung.php?Id=".$data['Id']."'>Hapus</a></td>";
    echo "</tr>";
  }
  ?>
  </table>
  ...
  <div id="popup1" class="overlay">
        <div class="popup">
                ...
                <form method="post" action="tambahgunung.php" enctype="multipart/form-data">
