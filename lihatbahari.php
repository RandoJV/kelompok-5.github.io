...
<br>
        ...
        <h1><center><span class="purple">WISATA</span> <span class="yellow">BAHARI</span></h1>
        <br>
<table class="container hover" id="table_id">
  ...
  $query = "SELECT * FROM wisata_bahari"; // Query untuk menampilkan semua data siswa
  ...
  while($data = mysqli_fetch_array($sql)){ // Ambil semua data dari hasil eksekusi $sql
    ...
    echo "<td><center><a href='ubahbahari.php?Id=".$data['Id']."'>Ubah</a></td>";
    echo "<td><center><a href='hapusbahari.php?Id=".$data['Id']."'>Hapus</a></td>";
    echo "</tr>";
  }
  ?>
  </table>
  ...
  <div id="popup1" class="overlay">
        <div class="popup">
                ...
                <form method="post" action="tambahbahari.php" enctype="multipart/form-data">
